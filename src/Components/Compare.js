  ...
  return (
    <div>
      ...
      <div className="Login">
        <Popover>
          ...
          <Portal>
            <PopoverContent>
              ...
              <PopoverCloseButton />
              <PopoverBody>
                <div>Email:- geustuser@gmail.com</div>
              </PopoverBody>
              <PopoverFooter>
                <div>Email:- geustuser2@gmail.com</div>
              </PopoverFooter>
            </PopoverContent>
          </Portal>
        </Popover>
        ...
        />
        <Button onClick={smbit} marginBottom={"1rem"} textAlign={"center"}>
          Compare
        </Button>
        ...
        {DailyDatac[0] ? (
          <>
            ...
            <Text marginTop={"3rem"} color={"green"} fontSize={"3rem"}>
