                  ...
                  <h2>
                    <AccordionButton>
                      ...
                      >
                        ...
                        >
                          <Box>{e.title}</Box>
                          <Box alignItems={"center"}>{e.Date}</Box>
                          <Box alignItems={"center"}>{e.carbonFactor}</Box>
                        </Stack>
                      </Box>
                      <AccordionIcon />
                    </AccordionButton>
                  ...
                  <AccordionPanel pb={4}>
                    ...
                    >
                      ...
                      <Box>
                        ...
                        <p>
                          CarbonFootprint = electricity * 0.0023 + diesel *
                          0.0063 + petrol * 0.0072 + water * 0.001 * 0.149 + gas
                          * 0.18316 + paper * 1.04
                        </p>
                      </Box>
                      <Box>
